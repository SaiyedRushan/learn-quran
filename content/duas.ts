      ...
      duas: [
        {
          ...
          note: "An equally authentic alternative reported in Bukhari & Muslim begins <em>Allahumma baʿid bayni wa bayna khatayaya kama baʿadta bayna-l-mashriqi wa-l-maghrib</em> (\"O Allah, distance me from my sins as You have distanced the east from the west\"). Either may be used; follow your own madhhab or teacher.",
        ...
        },
        {
          ...
          source: "Qur'an 16:98; Bukhari & Muslim",
        },
      ],
    },
    {
      ...
      duas: [
        {
          ...
          source: "Bukhari & Muslim (Ibn Masʿud)",
        },
        {
    ...
    },
    {
      ...
      duas: [
        ...
        },
        {
          ...
          source: "Bukhari & Muslim (Abu Bakr aṣ-Ṣiddiq)",
        },
        {
          ...
          source: "Abu Dawud (taught to Muʿadh)",
        },
        {
      ...
      duas: [
        {
          ...
          source: "Abu Dawud, Tirmidhi & Nasaʿi (sahih/hasan)",
        },
        {
